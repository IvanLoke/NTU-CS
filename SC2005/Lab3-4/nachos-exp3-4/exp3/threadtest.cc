...
Semaphore* s1 = new Semaphore("Semaphore",1);
//fill your code
...
void TestConsistency()
{
	...
	Thread* t2 = new Thread("Dec_Consistent_1");
	t1->Fork(Inc_Consistent,0,0);
	t2->Fork(Dec_Consistent,0,0);

	Thread *t3 = new Thread("Inc_Consistent_2");
	Thread *t4 = new Thread("Dec_Consistent_2");
	t3->Fork(Inc_Consistent,1,0);
